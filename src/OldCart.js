...
import Product from './OldProducts';
...
export default class Cart extends React.Component{
    ...
    accessChild=()=> {
        this.refs.child.calctotal() // do stuff
      }
                ...
                <div> 
                    ...
                    <div>
                         {Products.map(productlist =>{    
                           return <Product ref="child"  key={productlist.id} name={productlist.name}
                            description={productlist.description} price={productlist.price}
                            src={productlist.img_link} />
                        })}   
                        
                    </div> <hr/>
                    <div>
                        <button onClick={this.accessChild} > total </button>
                    </div>
